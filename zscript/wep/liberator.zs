...
class AutoReloader:AutoReloadingThingy{
	default{
		...
		hdweapon.nicename "7.76mm Auto-Reloader";
	}
...
class LiberatorNoGL:HDWeaponGiver{
	default{
		...
		hdweapon.nicename "Liberator Rifle (no GL)";
...
class LiberatorNoBullpup:HDWeaponGiver{
	default{
		...
		hdweapon.nicename "Liberator Rifle (Classic)";
...
class LiberatorNoBullpupNoGL:HDWeaponGiver{
	default{
		...
		hdweapon.nicename "Liberator Rifle (Classic no GL)";
